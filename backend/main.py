...
from api.routes import estados, users, equipos, ordenes, auth, repuestos, preventivo, historial, reportes, documentos, herramientas, configuracion, proveedores, contratos, costos
...
app.include_router(costos.router)  # v0.9.21: RF11 costos adicionales por OT
