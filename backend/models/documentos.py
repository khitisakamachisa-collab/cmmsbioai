...
class DocumentoAdjunto(SQLModel, table=True):
    ...
    # Entidad asociada: puede ser una OT, un Equipo, un Repuesto, una Herramienta o un Costo
    ...
    herramienta_id: Optional[int] = Field(default=None, foreign_key="herramienta.id")
    ot_costo_id: Optional[int] = Field(default=None, foreign_key="otcostoadicional.id")  # v0.9.1: RF11
